...
function displayValues(data) {
  ...
  flikeElem.innerHTML = `Ощущается как ${flike}°`;
...
fetchLatLong(54.72065114546184, 20.477052639040345); // valores de latitude e longitude para a cidade de Londres(cidade padrão)
getGeolocation();
